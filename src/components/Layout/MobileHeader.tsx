...
export const MobileHeader = () => {
	...
	return (
		<>
			<header className="md:hidden fixed top-0 left-0 right-0 h-16 bg-surface/90 backdrop-blur-md border-b border-zinc-800 z-[60] flex items-center justify-between px-6">
				<div
					onClick={handleLogoClick}
					className="select-none text-lg font-bold tracking-tighter text-white flex items-center gap-1 cursor-pointer active:opacity-70 transition-opacity"
				>
			...
			<AnimatePresence>
				{isOpen && (
					...
					>
						<div className="h-16 flex items-center justify-between px-6 border-b border-zinc-800 bg-surface shrink-0">
